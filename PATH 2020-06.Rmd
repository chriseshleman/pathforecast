...
Confirm represents 2019 Q3 forecast outputs. DONE. 
Add and update diagnostics. DONE. 
Package outputs (inputs, forecast and diagnostics). DONE [diagnostics by hand, for now.]
Automate real fare calculation. 
Rebuild process with new component pieces. 
Clean code. 
Add narrative. 
...
#writeWorksheet(wb, as.numeric(fitted(fit)), sheet = "Monthly", startRow = 3, startCol = 25, header=TRUE) #rownames = "Y-hat") 
#writeWorksheet(wb, as.numeric(fitted(fitsat)), sheet = "Monthly", startRow = 3, startCol = 26, header=TRUE) #rownames = "Y-hat") 
#writeWorksheet(wb, as.numeric(fitted(fitsun)), sheet = "Monthly", startRow = 3, startCol = 27, header=TRUE) #rownames = "Y-hat") 
...
#writeWorksheet(wb, durbinWatsonTest(as.vector(resid(fit))), sheet = "Diagnostics", startRow=102, startCol=2, header=TRUE) 
#writeWorksheet(wb, durbinWatsonTest(as.vector(resid(fitsat))), sheet = "Diagnostics", startRow=104, startCol=2, header=TRUE) 
#writeWorksheet(wb, durbinWatsonTest(as.vector(resid(fitsun))), sheet = "Diagnostics", startRow=106, startCol=2, header=TRUE) 
