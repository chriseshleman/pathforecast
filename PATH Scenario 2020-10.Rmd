...
```{r, echo=TRUE}
path$cpi_base = path[path$month==end_cpi, "cpi_2020_10"] 
path$real_farefare = ifelse(path$month <= end, path$fare_nominal * path$cpi_base / path$cpi_2020_10, max(path$fare_nominal)) 
path$cpi_base = NULL 
```
...
### WEEKDAYS 
oldreg=as.matrix(data.frame(before$man_hud_2020_10,                       
...
newreg=as.matrix(data.frame(after$man_hud_2020_10, 
...
### SATURDAY & SUNDAY 
oldregsat=as.matrix(data.frame(before$pop_hudson_2020_10, 
...
newregsat=as.matrix(data.frame(after$pop_hudson_2020_10,  
                            after$dummy_2, after$dummy_3, after$dummy_4, after$dummy_5, 
                            after$dummy_6, after$dummy_7, after$dummy_8, after$dummy_9, 
                            after$dummy_10, after$dummy_11, after$dummy_12, 
                            after$dum_911_base, 
